...
- The AArch64 timer singleton used `spin::Once` even on RPi3, contrary to the RPi3 single-core/exclusive-atomic constraint. It now uses `boot::SimpleOnce`; this is a defensive fix but has not yet been isolated as the remaining boot-stop cause.
