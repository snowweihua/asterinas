...
impl CpuException {
    pub(crate) fn from_esr(esr_el1: usize, far_el1: usize) -> Self {
        let ec = ((esr_el1 >> 26) & 0x3f) as usize;
        let is_write = (esr_el1 >> 6) & 1 == 1;
        match ec {
            0 => Self::Unknown,
            ...
            8 => Self::TrappedTimer,
            0x20 => Self::InstructionAbortLowerEL(far_el1),
            0x21 => Self::InstructionAbortCurrentEL(far_el1),
            0x22 => Self::PCAlignmentFault,
            0x24 => Self::DataAbortLowerEL(far_el1, is_write),
            0x25 => Self::DataAbortCurrentEL(far_el1, is_write),
    ...
    const fn type_(&self) -> CpuExceptionType {
        match self {
            ...
            Self::InstructionAbortLowerEL(_) | Self::DataAbortLowerEL(..) => CpuExceptionType::Fault,
            Self::InstructionAbortCurrentEL(_) | Self::DataAbortCurrentEL(..) => CpuExceptionType::Abort,
...
impl UserContextApiInternal for UserContext {
    fn execute<T: UserModeHooks>(&mut self, hooks: &T) -> ReturnReason {
        ...
        let ret = loop {
            ...
            let cpu_exception = CpuException::from_esr(self.user_context.esr_el1, far_el1);
            match cpu_exception {
